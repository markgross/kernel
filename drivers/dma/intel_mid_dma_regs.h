...
struct intel_mid_dma_ops {
	...
	int (*device_config)(struct dma_chan *chan, struct dma_slave_config *cfg);
	int (*device_terminate_all)(struct dma_chan *chan, struct dma_slave_config *cfg);
...
/* Disabled DMA acpi prototypes; not needed for Intel Merrifield/Edison
 * and this file is being phased out of upstream.
